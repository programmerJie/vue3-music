<template>
  ...
  <div class="commentContentTop1" v-for="item in mv.hotComments" :key="item" v-if="ifShow.btn1">
    <div class="left">
  ...
  <div class="commentContentTop2" v-for="item in mv.hotComments" :key="item" v-if="ifShow.btn2">
    <div class="left">
      <span><img :src="item['user']['avatarUrl']" alt=""></span>
      <div>
        <span>{{ item['user']['nickname'] }}</span>
  ...
  <div class="commentContentTop3" v-for="item in mv.comments" :key="item" v-if="ifShow.btn3">
    <div class="left">
      <span><img :src="item['user']['avatarUrl']" alt=""></span>
      <div>
        <span>{{ item['user']['nickname'] }}</span>
...
import {MvApi, MvCommentApi} from "../../../api/Mv";
